...
contract DeployPresaleEthereum is Script {
    ...
    function run() external returns (Presale) {
        ...
        address paymentWallet_ = 0x9d44eBDdFf2Bc2cF6a1Ab1918F7358972Ce50D28;
        address ownerWallet_ = 0x9d44eBDdFf2Bc2cF6a1Ab1918F7358972Ce50D28;
        ...
        Presale presale = new Presale(merkatTokenAddress, usdtAddress_, usdcAddress_, aggregatorContract_, stakingContract_, paymentWallet_, ownerWallet_, phases_, maxTotalSellingAmount_, usdLimitPhase0_, usdLimitPhase1_);
        vm.stopBroadcast();
        return presale;
    }
}
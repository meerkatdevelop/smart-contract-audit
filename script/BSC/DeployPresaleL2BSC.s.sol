...
contract DeployPresaleL2BSC is Script {
    ...
    function run() external returns (PresaleL2) {
        ...
        phases_[0] = [20000  * 10**18, 5000, 47128000   ]; // @audit CAMBIAR A FINAL
        phases_[1] = [20000  * 10**18, 15000, 47188000   ]; // @audit CAMBIAR A FINAL
        phases_[2] = [20000  * 10**18, 30000, 47228000]; // @audit CAMBIAR A FINAL
